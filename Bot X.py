...
faq = {
    ...
    "ایلان ماسک و خانواده؟": "ایلان ماسک ۱۴ فرزند داره: نوادا، ویویان، گریفین، کای، ساکسون، دامیان، X Æ A-Xii، اکسا، تکنو، استرايدر، آزور، آرکادیا،セルدون.",
...
def normalize(text):
    return text.strip().lower().replace("؟", "").replace("چیست", "چیه").replace("  ", " ").replace("اسپیس ایکس", "اسپیس‌ایکس").replace("ایکس ای آی", "xai").replace("ای آی ایکس", "xai")
...
def find_answer(question):
    ...
    for key, answer in faq.items():
        if any(word in normalize(key) for word in norm_q.split()):
...
print("=" * 80)
print("   BOT X - نسخه 2.1")
print("   دانشنامه کامل + جستجوی هوشمند!")
print("   ساخته: بهارناز نوری منش (11 ساله، ایران)")
print("   تعداد سوالات: 105")
print("=" * 80)

print("\nسلام! من Bot X هستم! حالا با جستجوی هوشمند")
print("سوالات رو هر جور بخوای بپرس!")

print("\n" + "=" * 80)
print("نمونه سوالات:")
print("=" * 80)
samples = ["هوش مصنوعی چیه؟", "ایلان ماسک کیست؟", "اسپیس‌ایکس چیه؟", "تسلا چیه؟", "xAI چیه؟"]
for i, q in enumerate(samples, 1):
    print(f"   {i}. {q}")

print("\n" + "-" * 80)
question = input("سوالت رو بپرس (هر جور بخوای!):\n> ").strip()
...
print("   خداحافظ دوست خوبم . از اینکه با شما گفت و گو کردم بسیار خوشحالم")
print("=" * 80)